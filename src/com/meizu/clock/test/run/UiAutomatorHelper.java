...
public class UiAutomatorHelper {
    ...
    public static void main(String[] args) {
		UiAutomatorHelper ui = new UiAutomatorHelper("clock", "ClockSanityTestNewCase", "test044TimingPause", "3");
	}
...
//		modfileBuild();
	...
	*/
	...
	public void runTest(String jarName, String testName) {
		...
		String testCmd = jarName + ".jar " + "-c com.meizu.clock.test." + testName;
